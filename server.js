...
const defaultPrompt = `
本日は ${new Date().toLocaleDateString('ja-JP', { year: 'numeric', month: 'long', day: 'numeric' })} の放送です。全国全体では晴れ間が広がる中、一部地域では雨や雪の兆候も見られます。最新の天気予報情報を元に、放送に必要な情報を1～2項目選び、適切に紹介してください。

【全国天気】：全国全体の天候傾向を1～2文で簡潔にまとめる。  
【全国気温】：全国の気温動向を1～2文で簡潔にまとめる。  
【週間予報】：1週間の天気の傾向を簡潔にまとめる。
