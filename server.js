...
【前半】  
・冒頭で本日の放送日付と全体の天候傾向（例：「全国的に晴れ間が広がる中、局地的に雨模様」など）を述べる。  
・その後、全国の雨や雪の様子、雲画像、天気図、あすの天気図、あすの雨の予想、天気分布予想などの情報から、その日の放送に必要と思われる1～2項目をピックアップして紹介する。

【後半】  
・必ず【全国天気】、【全国気温】、【週間予報】の各セクションを記載し、全国の主要都市（例：東京、大阪、名古屋、札幌、福岡）の最新天気、気温、週間予報を具体的な数値や特徴とともに紹介する。
...
app.post('/generate-weather-script', async (req, res) => {
  try {
    ...
    // OpenAI APIへリクエスト送信（モデルをgpt-3.5-turboに修正）
